...
gnome-terminal --working-directory=$NGSIEMULATOR_HOME -x sh -c "java -cp mocks-$VERSION-jar-with-dependencies.jar -Deu.neclab.ioplatform.mocks.iotprovider.configurationFile=\"/tmp/iotprovider1.ini\" eu.neclab.iotplatform.mocks.server.MainIoTProvider"
...
gnome-terminal --working-directory=$NGSIEMULATOR_HOME -x sh -c "java -cp mocks-$VERSION-jar-with-dependencies.jar -Deu.neclab.ioplatform.mocks.iotprovider.configurationFile=\"/tmp/iotprovider2.ini\" eu.neclab.iotplatform.mocks.server.MainIoTProvider"
...
gnome-terminal --working-directory=$NGSIEMULATOR_HOME -x sh -c "java -cp mocks-$VERSION-jar-with-dependencies.jar eu.neclab.iotplatform.mocks.server.MainApplication"
